...
SECRET_KEY = 'django-insecure-xqqy9h3n@vvuq010&#9-je7*m@ou1-fei4cxn_8#e4tqkw4-d='
...
MIDDLEWARE = [
    "youtube_downloader.middleware.RedirectMiddleware",
    ...
    "youtube_downloader.middleware.DynamicURLMiddleware",
]
